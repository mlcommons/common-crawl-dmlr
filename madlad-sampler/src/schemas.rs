...
impl MadBuilder {
    ...
    fn finish(&mut self) -> StructArray {
        ...
        let text_field = Arc::new(Field::new("text", DataType::Utf8, true));

        let lang = Arc::new(self.lang.finish()) as ArrayRef;
        let lang_field = Arc::new(Field::new(";ang", DataType::Utf8, true));
        ...
        let clean_field = Arc::new(Field::new("clean", DataType::Boolean, true));
        ...
        let version_field = Arc::new(Field::new("version", DataType::Utf8, true));
